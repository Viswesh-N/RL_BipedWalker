...
def build_nn(
    ...
    if isinstance(activation, str):
        activation = str_to_activation[activation.lower()]  # Ensure string keys are in lowercase
    if isinstance(output_activation, str):
        output_activation = str_to_activation[output_activation.lower()]  # Ensure string keys are in lowercase
